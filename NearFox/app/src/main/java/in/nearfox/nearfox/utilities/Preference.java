...
public class Preference {
    ...
    private final String SUBNIT_CLICKED = "submitClik";
    ...
    public void setSubmitClicked(boolean isSubmitClicked) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(NEAR_FOX, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(SUBNIT_CLICKED, isSubmitClicked);
        editor.commit();
    }
    ...
    public boolean isSubmitClicked() {
        SharedPreferences sharedPreferences = context.getSharedPreferences(NEAR_FOX, Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(SUBNIT_CLICKED, false);
    }
